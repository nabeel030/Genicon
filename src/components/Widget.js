                                                ...
                                                enabledButtonsCount() > 1 && (
                                                    <div className='row mb-3'>
                                                        ...
                                                        <label class="form-label">Toggle Button Color</label>
                                                            <input style={{width: '32.5%'}} type="color" 
                                ...
                                <ul className='widgets-list'>
                                    {
                                        enableWhatsapp && 
                                        <li>
                                            <a className="widget-circle widget-whatsapp" target='_blank' href={`https://wa.me/${links.whatsapp}?text=Hello%20I%20saw%20your%20site%20and%20want%20to%20know%20more`}>
                                    ...
                                    }
                                    {
                                        enableInsta && 
                                        <li>
                                            <a className="widget-circle widget-insta" target='_blank' href={`https://www.instagram.com/${links.instagram}`}>
                                    ...
                                    }
                                    {
                                        enableSkype && 
                                        <li>
                                            <a className="widget-circle widget-skype" target='_blank' href={`${links.skype}`}>
                                    ...
                                    }
                                    {
                                        enableMsger && 
                                        <li>
                                            <a className="widget-circle widget-messenger" target='_blank' href={`https://www.facebook.com/${links.messenger}`}>
                                    ...
                                    }
                                    {
                                        enableTwitter && 
                                        <li>
                                            <a className="widget-circle widget-twitter" target='_blank' href={`https://www.twitter.com/${links.twitter}`}>
                                    ...
                                    }
                                    {
                                        enableCall && 
                                        <li>
                                            <a className="widget-circle widget-call" target='_blank' href={`tel:${links.call}`}>
