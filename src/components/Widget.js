                                ...
                                enableWhatsapp && (
                                    <div className='platform-widgets-form text-left mt-2'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mx-5'>Example: 79851360066</p>
                                        </div>
                                    </div>
                                )
                            }
                                ...
                                enableInsta && (
                                    <div className='platform-widgets-form text-left mt-2'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mx-5'>Example: https://instagram.com/username</p>
                                        </div>
                                    </div>
                                )
                            }
                                ...
                                enableSkype && (
                                    <div className='platform-widgets-form text-left mt-2'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mx-5'>Example: https://skype.com/username</p>
                                        </div>
                                    </div>
                                )
                            }
                                ...
                                enableMsger && (
                                    <div className='platform-widgets-form text-left mt-2'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mx-5'>Example: https://facebook.com/storebuddy.co</p>
                                        </div>
                                    </div>
                                )
                            }
                                ...
                                enableTwitter && (
                                    <div className='platform-widgets-form text-left mt-2'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mx-5'>Example: https://twitter.com/account</p>
                                        </div>
                                    </div>
                                )
                            }
                                ...
                                enableCall && (
                                    <div className='platform-widgets-form text-left mt-2'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mx-5'>Example: +929851360066</p>
                                        </div>
                                    </div>
                                )
                            }
