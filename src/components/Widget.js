...
function Widget() {
    ...
    const getIconSpans = () => {
        ...
        const whatsappSpan = enableWhatsapp ? `<a class="widget-circle widget-whatsapp" href="${links.whatsapp}" style="margin-bottom: 15px;">${waIcon}</a>` : '';
        const msgerSpan = enableMsger ? `<a class="widget-circle widget-messenger" href="${links.messenger}" style="margin-bottom: 15px;">${msgerIcon}</a>` : '';
        const instaSpan = enableInsta ? `<a class="widget-circle widget-insta" href="${links.instagram}" style="margin-bottom: 15px;">${instaIcon}</a>` : '';
        const skypeSpan = enableSkype ? `<a class="widget-circle widget-skype" href="${links.skype}" style="margin-bottom: 15px;">${skypeIcon}</a>` : '';
        const twitterSpan = enableTwitter ? `<a class="widget-circle widget-twitter" href="${links.twitter}" style="margin-bottom: 15px;">${twitterIcon}</a>` : '';
        const callSpan = enableCall ? `<a class="widget-circle" href=${links.call}" style="margin-bottom: 15px;">${callIcon}</a>` : '';
